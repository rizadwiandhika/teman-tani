...
public class ProjectRunner {
  ...
  // public ProjectRunner(ProjectJpaRepository projectJpaRepository, ObjectMapper
  // objectMapper, EntityManager manager,
  // Mapper mapper) {
  ...
  // entities.stream().map(mapper::projectEntityToProjectObject)
