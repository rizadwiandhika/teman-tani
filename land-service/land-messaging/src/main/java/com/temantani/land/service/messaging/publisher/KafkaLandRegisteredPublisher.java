...
public class KafkaLandRegisteredPublisher implements LandRegisteredMessagePublisher {
  ...
  public KafkaLandRegisteredPublisher(KafkaProducer<String, String> producer,
  ...
  public void publish(LandRegistetedOutboxMessage outbox,
    ...
    String value = kafkaHelper.writeEventPayload(mapper.landRegisteredEventPayloadToLandRegistereModel(payload));
