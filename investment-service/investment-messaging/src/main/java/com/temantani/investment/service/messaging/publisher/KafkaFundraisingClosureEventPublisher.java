...
public class KafkaFundraisingClosureEventPublisher implements FundraisingClosureEventPublisher {
  ...
  public KafkaFundraisingClosureEventPublisher(KafkaProducer<String, String> publisher,
  ...
  public void publish(FundraisingClosureOutboxMessage message,
    ...
    String model = helper.writeEventPayload(mapper
        .fundraisingClosureEventPayloadToCloseFundraisingResponseJsonModel(payload));
