...
public class Project extends AggregateRoot<ProjectId> {
  ...
  public static Project createProject(ProjectId projectId, Money fundraisingTarget, ZonedDateTime tenorDeadline) {
    if (projectId == null) {
  ...
  public InvestmentCreatedEvent createInvestment(UserId investorId, Money amount) {
    ...
    Investment investment = Investment.builder()
        ...
        .amount(amount)
        .expiredAt(Helper.now().plusMinutes(30))
  ...
  public ProjectClosureEvent close() throws FundraisingClosedException {
    ...
    status = pendingInvestments.isEmpty() ? ProjectStatus.CLOSED : ProjectStatus.CLOSING;
  ...
  private Project(Builder builder) {
    ...
    this.investments = builder.investments.stream().collect(Collectors.toList());
