...
public class InvestmentDomainServiceImpl implements InvestmentDomainService {
  ...
  @Override
  public void cancelInvestment(Fundraising project, InvestmentId investmentId, List<String> reasons) {
    project.cancelInvestment(investmentId, reasons);
  }

  @Override
  public ProjectClosureEvent closeProjectForInvestment(Fundraising project) {
    project.cancelAllExipiredInvestments();
    return project.close();
  }

  @Override
  public void payInvestment(Fundraising project, InvestmentId investmentId) {
    project.acceptInvestment(investmentId);
  }

  @Override
  public InvestmentCreatedEvent validateAndInitiateInvestment(Fundraising project, Investor investor, Money amount) {
